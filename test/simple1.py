...
f1= flagdata(f1, mode='manual', antenna="82")
f1= flagdata(f1, mode='manual', spw="0:0~65")
f1= flagdata(f1, mode='manual', spw="0:377~387")
f1= flagdata(f1, mode='manual', spw="0:850~854")
f1= flagdata(f1, mode='manual', spw="0:930~1024")
f1= flagdata(f1, mode='manual', spw="0:831")
f1= flagdata(f1, mode='manual', spw="0:769")
f1= flagdata(f1, mode='manual', spw="0:511")
f1= flagdata(f1, mode='manual', spw="0:913")                
